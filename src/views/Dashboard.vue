<template>
  <template v-if="role == 'dei' || role == 'ppk' || role == 'penyedia'">
    <DashboardDei></DashboardDei>
  </template>
  <template v-else-if="role != 'pengawas'">
    <!--begin::Row-->
    <div class="row g-5 g-xl-10">
        ...
        <div class="card border" style="background-color: #d4d4d4">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center">
              <div
                class="d-flex flex-column align-items-center justify-content-center me-6"
              >
                <img
                  ...
                  alt=""
                />
                <span class="fw-bold text-center mt-4"
                  >APDAL <br />
                  <br />
                </span>
              </div>
              <div
                ...
                style="border-right: 1.4px solid black"
              >
                <span class="pb-3">Jumlah</span> <br />
                <span class="fs-6">10 Unit</span>
              </div>
              <div class="text-center ps-3">
                <span>Kapasitas</span> <br />
                <span class="fs-6">10 MW</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4 col-xl-3">
        <div class="card border" style="background-color: #c6ccfd">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center">
              <div
                class="d-flex flex-column align-items-center justify-content-center me-6"
              >
                <img
                  :src="getAssetPath('media/desain/icon-5.svg')"
                  class="w-30px"
                  alt=""
                />
                <span class="fw-bold text-center mt-4"
      ...
      <div class="col-md-4 col-xl-3">
        <div class="card border text-white" style="background-color: #030303">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center">
              <div
                class="d-flex flex-column align-items-center justify-content-center me-6"
              >
                <img
                  :src="getAssetPath('media/desain/icon-6.svg')"
                  class="w-30px"
                  alt=""
                />
                <span class="fw-bold text-center mt-4"
              ...
              <div
                class="text-center pe-3"
                style="border-right: 1.4px solid white"
              >
                <span class="pb-3">Jumlah</span> <br />
                <span class="fs-6">10 Unit</span>
              </div>
      ...
      <div class="col-md-4 col-xl-3">
        <div class="card border" style="background-color: #fecdcd">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center">
              <div
                class="d-flex flex-column align-items-center justify-content-center me-6"
              >
                <img
                  :src="getAssetPath('media/desain/icon-7.svg')"
                  class="w-30px"
                  alt=""
                />
                <span class="fw-bold text-center mt-4"
      ...
      <div class="col-md-4 col-xl-3">
        <div class="card border" style="background-color: #f9f3d3">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center">
              <div
                class="d-flex flex-column align-items-center justify-content-center me-6"
              >
                <img
                  :src="getAssetPath('media/desain/icon-9.svg')"
                  class="w-30px"
                  alt=""
                />
                <span class="fw-bold text-center mt-4"
        ...
        <div class="card border" style="background-color: #d4d4d4">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-center">
              ...
              >
                <img
                  :src="getAssetPath('media/desain/icon-8.svg')"
                  class="w-30px"
                  alt=""
                />
                <span class="fw-bold text-center mt-4"
    ...
    <div class="row mt-18">
      <div class="col-md-12 d-flex justify-content-between mb-5">
        <h1 class="fs-1">Usulan</h1>
        <router-link v-if="role == 'pengusul'" to="/usulan">
      ...
      <div class="col-md-12">
        ...
        >
          ...
          <template v-slot:cell-kelengkapan_dokumen="{ row: data }">
            <template v-if="data.kelengkapan_dokumen">
              <div class="badge badge-success">Disetujui</div>
            </template>
            <template v-else-if="!data.kelengkapan_dokumen">
          ...
          <template v-slot:cell-status_nadine="{ row: data }">
            ...
            <template v-else-if="data.status_nadine == 'Ditolak'">
              <div class="badge badge-danger">Diterima</div>
            </template>
...
import DashboardDei from "./DashboardDei.vue";
